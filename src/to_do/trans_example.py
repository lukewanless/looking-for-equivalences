        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [
                        -1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    logs = {}
                    if (
                ...
                if args.local_rank in [
                        -1, 0] and args.save_steps > 0 and global_step % args.save_steps == 0:
...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        if task in [
                "mnli", "mnli-mm"] and args.model_type in ["roberta", "xlmroberta"]:
...
def main():
    ...
    if args.do_train and (args.local_rank == -
