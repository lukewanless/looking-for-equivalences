...
r_path = "results/{}/roberta_large/syn_p_h/batch{}".format(folder, b)
rr_path = "raw_results/{}/roberta_large/syn_p_h/batch{}".format(folder, b)
...
with open("roberta_large_script.sh", "w") as file:
    ...
    for rho in all_rhos:
        ...
        command = "python3 wordnet_syn_test_roberta_large.py {} {:.2f} {} {} {} {} {}\n".format(folder,
                                                                                             rho,
                                                                                             search_random_state,
                                                                                             dgp,
                                                                                             train,
        ...
        file.write(command)
    file.write(
        "mv results/{0}/roberta_large/syn_p_h/rho_* results/{0}/roberta_large/syn_p_h/batch{1}\n".format(folder, b))
    file.write(
        "mv raw_results/{0}/roberta_large/syn_p_h/rho_* raw_results/{0}/roberta_large/syn_p_h/batch{1}".format(folder, b))
