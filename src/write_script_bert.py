...
r_path = "results/{}/bert_base/syn_p_h/batch{}".format(folder, b)
rr_path = "raw_results/{}/bert_base/syn_p_h/batch{}".format(folder, b)
...
with open("bert_script.sh", "w") as file:
    ...
    for rho in all_rhos:
        ...
        command = "python3 wordnet_syn_test_bert_base.py {} {:.2f} {} {} {} {} {}\n".format(folder,
                                                                                             rho,
                                                                                             search_random_state,
                                                                                             dgp,
                                                                                             train,
        ...
        file.write(command)
    file.write(
        "mv results/{0}/bert_base/syn_p_h/rho_* results/{0}/bert_base/syn_p_h/batch{1}\n".format(folder, b))
    file.write(
        "mv raw_results/{0}/bert_base/syn_p_h/rho_* raw_results/{0}/bert_base/syn_p_h/batch{1}".format(folder, b))
